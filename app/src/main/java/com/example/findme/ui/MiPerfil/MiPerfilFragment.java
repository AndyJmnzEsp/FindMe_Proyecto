...
import com.example.findme.databinding.FragmentMiperfilBinding;

public class MiPerfilFragment extends Fragment {

    private com.example.findme.ui.MiPerfil.MiPerfilViewModel miPerfilViewModel;
    private FragmentMiperfilBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        miPerfilViewModel =
                new ViewModelProvider(this).get(com.example.findme.ui.MiPerfil.MiPerfilViewModel.class);
